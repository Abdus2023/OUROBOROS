...
```text
ouroboros/M0/ourob/      implementation (kernel, policy, skills, verify, evidence, promotion, bootstrap, recovery, trust, signed_trust, trust_lifecycle, trust_recovery, planner, cli)
